...
export default function ShoppingCart() {
  ...
  const discountAmount =
    couponApplied && couponCode.toUpperCase() === "DISCOUNT10"
      ? subtotal * 0.1
      : 0;
  ...
  const handleClearCart = () => {
    if (
      cart.length > 0 &&
      window.confirm("Are you sure you want to empty your cart?")
    ) {
      clearCart();
      setCouponApplied(false);
      setCouponCode("");
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
          ...
          <div className="flex-grow lg:w-2/3">
            ...
            <div className="mt-6 flex flex-col sm:flex-row justify-between items-center gap-4">
              ...
              <Link
                href="/shop"
                className="inline-flex items-center gap-2 px-5 py-2 border border-gray-300 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors"
              >
            ...
            <div className="mt-8 bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
              ...
              >
                <input
                  ...
                  className={`px-4 py-2 border rounded-md flex-grow text-sm focus:outline-none focus:ring-2 ${
                    couponError
          ...
          <div className="w-full lg:w-1/3">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6 sticky top-6 ">
              ...
              <button
                ...
                className="w-full py-3 bg-green-600 text-white rounded-md font-medium hover:bg-green-700 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 disabled:bg-gray-400 cursor-pointer"
                disabled={cart.length === 0}
              >
                <Link
                  href="/checkout"
